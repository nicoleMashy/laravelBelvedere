...
<html>
<head>
    <title>ZCC_HARARE_BELVEDERE_WELLNESS_CENTRE</title>
    ...
    <div id="overlay-1">
            ...
            <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#">ZCC</a>
                    </div>
        ...
        <section id="starting">
            <div class="text-center starting-text">
                <h1 class="rene">ZION CHRISTIAN CHURCH</h1>
    ...
    <div class="container">
        <div class="row text-center" id="heading">
            <div class="col-md-6 col-md-offset-3 wow animated zoomInDown" id="heading-text">
                <h3>About Us</h3>
                <p>THE ALMIGHTY IS HERE TO HELP YOU</p>
                <hr class="full">
                <br/>
            </div>
        </div>	<!-- row -->
        ...
        <div class="row post">
            <div class="main_content">
                <div class="post-thumbnail col-md-5">
                    ...
                    <img class="hidden-xs post-shadow" src="/app-assets/img/post-shadow.png" alt=""/>
                </div>
                <div class="post-excerpt col-md-7">
                    <h2 class="title">
            ...
            <div class="main_content">
                <div class="post-thumbnail col-md-5">
                    <div class="frame">
                        ...
                        <a href="#"><img class= "img-responsive" src="/app-assets/img/blog3.png" alt=""/></a>
                    </div>
                    <img class="hidden-xs post-shadow" src="/app-assets/img/post-shadow.png" alt=""/>
                </div>
                <div class="post-excerpt col-md-7">
            ...
            <div class="main_content">
                <div class="post-thumbnail col-md-5">
                    <div class="frame">
                        ...
                        <a href="#"><img class= "img-responsive" src="/app-assets/img/global_focus.jpg" alt=""/></a>
                    </div>
                    <img class="hidden-xs post-shadow" src="/app-assets/img/post-shadow.png" alt=""/>
                </div>
                <div class="post-excerpt col-md-7">
            ...
            <div class= "col-md-6 col-md-offset-3">
                <div id="client-speech" class="owl-carousel owl-theme">
                    <div class="item">
                        <div class= "row">
                            <div class= "col-md-6 col-md-offset-3">
                                <img class= "img-circle img-responsive center-block" src="/app-assets/img/client1.png">
                            </div>
                            <div class= "col-md-12">
                    ...
                    <div class="item">
                        <div class= "row">
                            <div class= "col-md-6 col-md-offset-3">
                                <img class= "img-circle img-responsive center-block" src="/app-assets/img/client2.jpg">
                            </div>
                            <div class= "col-md-12">
                                <p class= "client-comment text-center">
                    ...
                    <div class="item">
                        <div class= "row">
                            <div class= "col-md-6 col-md-offset-3">
                                <img class= "img-circle img-responsive center-block" src="/app-assets/img/client3.png">
                            </div>
                            <div class= "col-md-12">
                                <p class= "client-comment text-center">
